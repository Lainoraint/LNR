...
class RatusanPage extends StatefulWidget {
  final String number;

  const RatusanPage({super.key, required this.number});

  @override
  State<RatusanPage> createState() => _RatusanPageState();
}

class _RatusanPageState extends State<RatusanPage> {
  ...
  Future<void> _uploadToFirebase(String filePath, String number) async {
    try {
      ...
      final mainRef = FirebaseStorage.instance
          .ref()
          .child('dataset_angka/ratusan/$number/$timestamp.png');
      ...
      for (int i = 0; i < additionalImages.length; i++) {
        ...
        final additionalRef = FirebaseStorage.instance
            .ref()
            .child('dataset_angka/ratusan/$number/${timestamp + i + 1}.png');
          ...
          children: [
            ...
            Center(
              child: Align(
                ...
                child: InkWell(
                  child: Image.asset(
                    'assets/menulis/angka/papan_ratusan.png',
