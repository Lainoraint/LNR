...
class SatuanPage extends StatefulWidget {
  ...
  const SatuanPage({super.key, required this.number});
...
class _SatuanPageState extends State<SatuanPage> {
  ...
  // Fungsi untuk menghitung batas gambar berdasarkan titik-titik
  ...
  Future<void> _uploadToFirebase(String filePath, String number) async {
    try {
      ...
      final mainRef = FirebaseStorage.instance
          .ref()
          .child('dataset_angka/satuan/$number/$timestamp.png');
      ...
      for (int i = 0; i < additionalImages.length; i++) {
        ...
        final additionalRef = FirebaseStorage.instance
            .ref()
            .child('dataset_angka/satuan/$number/${timestamp + i + 1}.png');
        ...
        children: [
          ...
          Center(
            child: Align(
              ...
              child: InkWell(
                child: Image.asset(
                  'assets/menulis/angka/papan_satuan.png',
